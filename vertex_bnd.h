...
#ifndef CLASS_NIFS_C_VERTEX_BND_H
#define CLASS_NIFS_C_VERTEX_BND_H
...
// Boundary vertices class
// This type of vertex can move only along the boundary of the domain
class c_vertex_bnd : public c_vertex
{
	public:
		c_vertex_bnd() { }
		virtual ~c_vertex_bnd() { }
		virtual int get_type() { return 1; } // boundary vertex
};

} //--- namespace NIFS ---

#endif //--- CLASS_NIFS_C_VERTEX_BND_H ---
