...
NIFS::c_face_bnd_wall_neu::c_face_bnd_wall_neu() : 
									c_face_bnd_wall()
{
...
void 
NIFS::c_face_bnd_wall_neu::calc_coef_1()
{
	m_coef_1[0][0] = 0.0;
	m_coef_1[0][1] = 0.0;
	m_coef_1[0][2] = 0.0;
...
void 
NIFS::c_face_bnd_wall_neu::calc_coef_c()
{
	...
	m_coef_c[3] = -get_info().get_params()->get_gamma() * m_area * m_dt_dn +
			m_mfr * ( cell_ptr_1->get_grad().get_temp() * m_r1 );
}


void 
NIFS::c_face_bnd_wall_neu::calc_bc()
{
	c_face_bnd_wall::calc_bc();
	...
	m_dt_dn = get_info().get_bnd_cond()->get_temp( 
			get_code(), m_fmp.get_pos().get_x(), m_fmp.get_pos().get_y() );
}

void 
NIFS::c_face_bnd_wall_neu::calc_state()
{
	c_cell* cell_ptr_1 = static_cast<c_cell*>( get_cell(0) );
