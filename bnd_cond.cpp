...
void 
NIFS::c_bnd_cond::load_bc_file( std::string file_name )
{
	std::string line_str;
	unsigned line_num = 0;
...
unsigned 
NIFS::c_bnd_cond::get_bnd_num( void )
{ 
...
void 
NIFS::c_bnd_cond::set_bc_string( const std::string& bc_string )
{
	std::string::size_type index;
...
double
NIFS::c_bnd_cond::get_pres( unsigned bnd_code, double x, double y )
{
...
double
NIFS::c_bnd_cond::get_velu( unsigned bnd_code, double x, double y )
{
	m_parser.set_param( "x", x );
	m_parser.set_param( "y", y );
...
double
NIFS::c_bnd_cond::get_velv( unsigned bnd_code, double x, double y )
{
	m_parser.set_param( "x", x );
	m_parser.set_param( "y", y );
...
double
NIFS::c_bnd_cond::get_temp( unsigned bnd_code, double x, double y )
{
	m_parser.set_param( "x", x );
	m_parser.set_param( "y", y );
...
unsigned 
NIFS::c_bnd_cond::extract_index(	const std::string& str, 
...
unsigned 
NIFS::c_bnd_cond::get_bc_type( unsigned bnd_code )
{
	return m_bc_type[ bnd_code ];
}
