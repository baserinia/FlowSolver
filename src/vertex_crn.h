...
#ifndef CLASS_NIFS_C_VERTEX_CRN_H
#define CLASS_NIFS_C_VERTEX_CRN_H
...
// Corner vertices class
// This type of vertices remain fixed during adaptation process
class c_vertex_crn : public c_vertex 
{
	public:
		c_vertex_crn() { }
		virtual ~c_vertex_crn() { }
		virtual int get_type() { return 2; } // cornet vertex
};

} //--- namespace NIFS ---

#endif //--- CLASS_NIFS_C_VERTEX_CRN_H ---
